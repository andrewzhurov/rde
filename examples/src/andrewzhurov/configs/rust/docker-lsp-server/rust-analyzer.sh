...
IMAGE_NAME="andrewzhurov/rust-analyzer2"
...
if true; then #[[ $(docker images --filter "reference=$IMAGE_NAME" -q) == "" ]]; then
 ...
 # https://hub.docker.com/layers/rustlang/rust/nightly/images/sha256-e8e603411af19e12524c3b7f6bb6912b87727dd050ddaddf78422f634bcc13fd?context=explore
 FROM rustlang/rust@sha256:e8e603411af19e12524c3b7f6bb6912b87727dd050ddaddf78422f634bcc13fd
